...
public class ServerMain {
  ...
  // private static String DB_PASSWORD = "postgres";
    ...
    private static String DB_HOST = "1";
 //   private static String DB_HOST = "jdbc:postgresql://localhost:" + LOCAL_PORT +  "/postgres";


    private static String DB_USER = "1";
    private static String DB_PASSWORD = "1";
    private static String SSH_USER = "1";
    private static String SSH_PASSWORD = "1";
    private static String SSH_SERVER = "1";
    private static int SSH_PORT = 2222;
    private static int SSH_DB_PORT = 22;
//   private static int LOCAL_PORT = 5555;
    ...
    public static void main(String[] args) {
        ...
        if(collectionManager.loadJsonCollectionFromDatabase()) {
            LOGGER.log(Level.INFO,"Collection from the db was successfully loaded");
        }
